        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="<?php echo e(url('/')); ?>" class="nav-link"> SISTEMA DE CONTROL DE ASISTENCIA</a>
                </li>
            </ul>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <!-- MODULO MINISTERIOS -->
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ministerios')): ?>
                        <li class="nav-item">
                            <a href="#" class="nav-link active">
                                <i class="nav-icon fas">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo e(url('ministerios/create')); ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Nuevo Ministerio</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(url('ministerios')); ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('miembros')): ?>
                        <!-- MODULO MIEMBROS -->
                        <li class="nav-item">
                            <a href="#" class="nav-link active">
                                <i class="nav-icon fas">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo e(url('miembros/create')); ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Nuevo Miembro</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(url('miembros')); ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo e(url('asistencias/create')); ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Nueva Asistencia</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(url('asistencias')); ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo e(url('asistencias/reportes')); ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Asistencias</p>
                                    </a>
                                </li>
...
</html><?php /**PATH C:\xampp\htdocs\siscontroldeasistencia\resources\views/layouts/admin.blade.php ENDPATH**/ ?>